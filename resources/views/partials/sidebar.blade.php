...
<div class="br-sideleft overflow-y-auto">
  ...
  <div class="br-sideleft-menu">
    ...
    <ul class="br-menu-sub nav flex-column">
      ...
      <li class="nav-item"><a href="/manage/category" class="nav-link {{ Request::is('manage/category') || Request::is('manage/category/*') ? 'active' : '' }}">Kategori</a></li>
      <li class="nav-item"><a href="/manage/booking" class="nav-link {{ Request::is('manage/booking') || Request::is('manage/booking/*') ? 'active' : '' }}">Pemesanan</a></li>
    </ul>
