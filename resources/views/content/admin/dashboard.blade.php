...
@section('content')
  ...
  <div class="br-mainpanel">
    <div class="pd-30">
      ...
      <p class="mg-b-0">Manage quickly, the good website with easy data management.</p>
    </div><!-- d-flex -->
        ...
        <div class="col-sm-6 col-xl-4 mb-3">
          <div class="bg-primary overflow-hidden rounded">
            <div class="pd-25 d-flex align-items-center">
              ...
              <i class="bi bi-person-circle tx-60 lh-0 tx-white op-7"></i>
              <div class="mg-l-20">
                <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">User</p>
                <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1">{{ $userCount }}</p>
                <span class="tx-11 tx-roboto tx-white-6">Total data User</span>
              </div>
            </div>
          </div>
        </div><!-- col-3 -->
        <div class="col-sm-6 col-xl-4 mb-3">
          <div class="bg-info overflow-hidden rounded">
            <div class="pd-25 d-flex align-items-center">
              ...
              <i class="bi bi-card-list tx-60 lh-0 tx-white op-7"></i>
              <div class="mg-l-20">
                <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">Category</p>
                <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1">{{ $categoryCount }}</p>
                <span class="tx-11 tx-roboto tx-white-6">Total data Kecamatan</span>
              </div>
            </div>
          </div>
        </div><!-- col-3 -->
        <div class="col-sm-6 col-xl-4 mb-3">
          <div class="bg-teal overflow-hidden rounded">
            <div class="pd-25 d-flex align-items-center">
              ...
              <div class="mg-l-20">
                <p class="tx-10 tx-spacing-1 tx-mont tx-medium tx-uppercase tx-white-8 mg-b-10">Booking</p>
                <p class="tx-24 tx-white tx-lato tx-bold mg-b-2 lh-1">{{ $bookingCount }}</p>
                <span class="tx-11 tx-roboto tx-white-6">Total data Pasar</span>
              </div>
            </div>
          </div>
        </div><!-- col-3 -->
      ...
      {{-- <div class="row row-sm mg-t-20">
        <div class="col-8">
          <div class="card pd-0 bd-0 shadow-base">
            <div class="pd-x-30 pd-t-30 pd-b-15">
              <div class="d-flex align-items-center justify-content-between">
                ...
                <div class="tx-13">
                  <p class="mg-b-0"><span class="square-8 rounded-circle bg-purple mg-r-10"></span> TCP Reset Packets
                  </p>
          ...
          <div class="card bd-0 shadow-base pd-30 mg-t-20">
            ...
            <table class="table-valign-middle mg-b-0 table">
              <tbody>
                <tr>
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="progress mg-b-10">
                  <div class="progress-bar bg-primary progress-bar-xs wd-30p" role="progressbar" aria-valuenow="30"
                    aria-valuemin="0" aria-valuemax="100"></div>
                </div><!-- progress -->
                <p class="tx-12">Nulla consequat massa quis enim. Donec pede justo, fringilla vel...</p>
                <p class="tx-11 lh-3 mg-b-0">You can also use other progress variant found in <a href="progress.html"
                    target="blank">progress section</a>.</p>
              </div><!-- col-6 -->
        ...
        <div class="col-4">
          ...
          <div class="card bd-0 shadow-base pd-30">
            ...
            <div class="progress ht-5 mg-b-10">
              <div class="progress-bar bg-teal wd-60p" role="progressbar" aria-valuenow="60" aria-valuemin="0"
                aria-valuemax="100"></div>
            </div>

            <label class="tx-12 tx-gray-600 mg-b-10">Disk Usage (82.2%)</label>
            <div class="progress ht-5 mg-b-10">
              <div class="progress-bar bg-danger wd-70p" role="progressbar" aria-valuenow="70" aria-valuemin="0"
                aria-valuemax="100"></div>
            </div>

            <label class="tx-12 tx-gray-600 mg-b-10">Databases (63/100)</label>
            <div class="progress ht-5 mg-b-10">
              <div class="progress-bar bg-warning wd-50p" role="progressbar" aria-valuenow="50" aria-valuemin="0"
                aria-valuemax="100"></div>
            </div>

            <label class="tx-12 tx-gray-600 mg-b-10">Domains (30/50)</label>
            <div class="progress ht-5 mg-b-10">
              <div class="progress-bar bg-info wd-45p" role="progressbar" aria-valuenow="45" aria-valuemin="0"
                aria-valuemax="100"></div>
            </div>

            <label class="tx-12 tx-gray-600 mg-b-10">Email Account (13/50)</label>
            <div class="progress ht-5 mg-b-10">
              <div class="progress-bar bg-purple wd-65p" role="progressbar" aria-valuenow="65" aria-valuemin="0"
                aria-valuemax="100"></div>
            </div>
          ...
          <div class="card shadow-base bd-0 mg-t-20 bg-transparent">
            ...
            <div class="pd-20 rounded-bottom d-flex align-items-center justify-content-between bg-white">
